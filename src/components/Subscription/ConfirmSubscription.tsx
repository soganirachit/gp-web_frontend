...
const ConfirmSubscription: React.FC = () => {
      ...
      try {
        ...
        try {
          ...
          if (!normalizedDetails.basePackId) {
            console.error('Missing basePackId in subscription details:', normalizedDetails);
          ...
          localStorage.setItem('currentSubscription', JSON.stringify(normalizedDetails));
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const selectedDays = subscriptionDetails.type.toUpperCase() === 'DAILY' 
