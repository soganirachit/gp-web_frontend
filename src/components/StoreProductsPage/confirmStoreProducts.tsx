...
const ConfirmStoreProducts: React.FC = () => {
    ...
    if (!isStoreProduct) {
      ...
      try {
        ...
        if (
          ...
          navigate("/login", {
            state: { returnUrl: "/storeProduct/confirm" },
          });
        } else if (errorMessage.includes("Insufficient wallet balance")) {
          toast.error("Insufficient wallet balance");
          navigate("/wallet", {
            state: {
              returnUrl: "/storeProduct/confirm",
      ...
      <div className="bg-[#FFFBEB] mx-4 rounded-xl pb-24">
        ...
        {!isConfirmed && (
          <div className="px-4 pt-4">
            ...
            >
              {loading ? "Confirming..." : "Confirm storeProduct"}
            </button>
            <button
              onClick={() => navigate("/")}
...
export default ConfirmStoreProducts;
