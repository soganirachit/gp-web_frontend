  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 ">
      <div className="max-w-[800px] mx-auto flex justify-between items-center px-4 py-3 md:px-8 md:py-4 bg-white shadow-lg md:mt-10 rounded-t-lg">
        ...
        >
          <img src={homeIcon} alt="Home" className="w-6 h-6 mb-1 md:w-8 md:h-8" />
        ...
        <Link 
          ...
          className={`flex flex-col items-center text-center min-w-[64px]  md:min-w-[80px] ${
            isActive('/Manage-my-subscription') ? 'text-green-700' : 'text-gray-600'
          }`}
        >
          <img src={subscriptionIcon} alt="Subscriptions" className="w-6 h-6 mb-1 text-green-800 md:w-8 md:h-8" />
        ...
        >
          <img src={supportIcon} alt="Support" className="w-6 h-6 mb-1 md:w-8 md:h-8" />
        ...
        >
          <img src={accountIcon} alt="Account" className="w-6 h-6 mb-1 md:w-8 md:h-8" />
