...
**Generated:** 2026-04-02T19:39:06.203Z
**Tag:** Fix_V0.9
...
Stats: {
  generatedAt: '2026-04-02T19:39:06.253Z',
  suiteCount: 18,
  caseCount: 164,
  flowCount: 7,
  criticalCount: 53,
...
```json
{
  "timestamp": "2026-04-02T19:39:40.745Z",
  "ok": true,
  "checks": [
    {
...
- **Playwright:** SKIPPED (`SKIP_PLAYWRIGHT=1`)

## 5. API smoke (unauthenticated)
- **api-smoke:** PASS
```json
{
  "timestamp": "2026-04-02T19:39:40.813Z",
